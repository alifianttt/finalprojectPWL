...
function add($hasil, $id, $time){
    ...
    if(isset($_POST['starts'])){
        ...
        if($diag1=='ya' && $diag2=='ya' && $diag3=='ya'){
            ...
            header('Location: ../view-page/result.php?res=tidak');
        }
    }
    function listkode(){
        global $db;
        ...
        while($row = mysqli_fetch_array($sql)) {         
            ...
            echo "<td><a href=\""."../logic/delete.php?del=".$row['id_kelayakan']."\" class=\"btn btn-danger\" onclick=\"javascript: return confirm('Anda yakin hapus?')\">Delete</a></td>";    
        }
    }
